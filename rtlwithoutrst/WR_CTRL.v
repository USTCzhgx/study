...
module WR_CTRL (
    ...
    // Jump metadata is written by jump_pulse before RD_CTRL can consume it.
    // It remains invalid while rd_jump_pending/force_drain are cleared, so
    // these data registers do not require resettable cells.
